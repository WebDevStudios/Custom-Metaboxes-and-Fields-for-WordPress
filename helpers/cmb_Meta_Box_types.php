...
class cmb_Meta_Box_types {
	...
	public function taxonomy_select() {
		...
		if( ! empty( $option_none ) ) {
			$option_none_value = apply_filters( "cmv_taxonomy_select_{$this->_id()}_value", apply_filters( 'cmb_taxonomy_select_default_value', '' ) );
	...
	public function taxonomy_radio() {
		...
		if ( ! $terms ) {
			...
			$option_none  = $this->field->args( 'show_option_none' );
			if( ! empty( $option_none ) ) {
				$option_none_value = apply_filters( "cmv_taxonomy_radio_{$this->_id()}_value", apply_filters( 'cmb_taxonomy_radio_default_value', '' ) );
				$args = array(
