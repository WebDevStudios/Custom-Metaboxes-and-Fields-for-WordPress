 ...
 *************************************************************************/
	 ...
	 * @access public
	 *
	 * ( key 'validate_func' of each field )
	 * All validation methods use the names of these methods in the
	 * names of these methods in the definition of meta boxes
	 *
	 */
	...
	class cmb_Meta_Box {
		...
		/**
		 * Sets up the HTML to display the meta boxe fields
		 */
		function show () {
	...
	function cmb_force_send ( $args ) {
		...
		if ( isset( $_POST[ 'attachment_id' ] ) && '' != $_POST[ "attachment_id" ] ) {
			...
			/**
			 * { @internal
			 * Are there any conditions in which we don't want the Insert Into Post
